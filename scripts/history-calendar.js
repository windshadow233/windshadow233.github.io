...
hexo.extend.filter.register('after_generate',function() {
    if(hexo.config.history_calendar.enable){
        ...
        if(hexo.config.swiper && hexo.config.swiper.enable){
            ...
            var js_text =`<script data-pjax src="https://fastly.jsdelivr.net/gh/windshadow233/BlogStorage@files/js/baiduhistorycalendar@v1.0.1.js"></script>`
            ...
            var js_text =`<script src="https://fastly.jsdelivr.net/npm/swiper/swiper-bundle.min.js"></script><script data-pjax src="https://fastly.jsdelivr.net/gh/windshadow233/BlogStorage@files/js/baiduhistorycalendar@v1.0.1.js"></script>`
